...
<div class="scrollContainer" style="top: 0;"><div class="pad" style="border-radius: 8px;">
...
<form name="f1" method="post" action="organizer.addressbook.php?action={if isset($contact) && $contact}saveContact&id={$contact.id}{else}createContact{/if}&sid={$sid}" onsubmit="return(checkContactForm(this));">
	...
	<table class="listTable bg-light">
		<tr>
			<th class="listTableHead" colspan="3"> {if isset($contact) && $contact}{lng p="editcontact"}{else}<h4 style="font-weight: bold;">Add Contact</h4>{/if}</th>
		</tr>
		<tr>
